...
export const INITIAL_BUNKERS: Record<LineId, Bunker[]> = {
  1: [
    ...
    { c: 'DB12', ms: ['Klei Florisol Rubra 0-3mm', 'Klei granulaat EDR', 'Klei granulaat EDR 0-28 mm (BigBag)', 'Klei 1-4mm'], m: 'Klei Florisol Rubra 0-3mm', fx: false, me: false, shared: [1, 3] },
  ...
  2: [
    ...
    { c: 'DB07', ms: ['Klei 1-4mm', 'Klei Florisol Rubra 0-3mm', 'Klei granulaat EDR', 'Klei granulaat EDR 0-28 mm (BigBag)'], m: 'Klei 1-4mm', fx: false, me: false },
  ...
  3: [
    ...
    { c: 'DB12', ms: ['Klei Florisol Rubra 0-3mm', 'Klei granulaat EDR', 'Klei granulaat EDR 0-28 mm (BigBag)', 'Klei 1-4mm'], m: null, fx: false, me: false, shared: [1, 3] },
