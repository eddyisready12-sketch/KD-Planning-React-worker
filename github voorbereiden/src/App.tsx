...
export default function App() {
  ...
  const [dataSource, setDataSource] = useState(() => {
    ...
    const defaultData = {
      sheetUrl: 'https://docs.google.com/spreadsheets/d/17aCk5YCMQDb93r6oseFlGG04V-IRTbEEdAByGRFF0Zc/edit?usp=sharing',
      calibrationUrls: {
    ...
    if (saved) {
      try {
        ...
        const genericUrl = 'https://docs.google.com/spreadsheets/d/17aCk5YCMQDb93r6oseFlGG04V-IRTbEEdAByGRFF0Zc/edit?usp=sharing';
