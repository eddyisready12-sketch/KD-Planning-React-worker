...
import { fetchBunkerMaterialsFromSupabase, fetchBunkerStateFromSupabase, fetchDriverListFromSupabase, fetchIssuesFromSupabase, fetchOrdersFromSupabase, fetchPlannedOrderIdsFromSupabase, isSupabaseConfigured, resolveIssueInSupabase, writeBunkerMaterialsToSupabase, writeBunkersToSupabase, writeDriverListToSupabase, writeIssueToSupabase, writeOrdersToSupabase, writePlannedOrderIdsToSupabase, type SharedBunkerMaterialRow } from './services/supabaseService';
