        ...
        <>
            {view === 'operator' && (
              <OperatorView
                ...
                activeIssueEntries={activeIssueEntries}
                bunkers={bunkers}
                changePlannerTab={changePlannerTab}
                changeSelectedLine={changeSelectedLine}
                changeView={changeView}
                currentNeedsProlineCleaning={currentNeedsProlineCleaning}
                currentTime={currentTime}
                dataSource={dataSource}
                displayedCurrentActualEnd={displayedCurrentActualEnd}
                displayedCurrentActualStart={displayedCurrentActualStart}
                displayedCurrentEntry={displayedCurrentEntry}
                displayedCurrentOrder={displayedCurrentOrder}
                displayedCurrentProgress={displayedCurrentProgress}
                draggedOperatorOrderId={draggedOperatorOrderId}
                draggedOperatorOrderIdRef={draggedOperatorOrderIdRef}
                editIssue={editIssue}
                formatOperatorDateTimeRange={formatOperatorDateTimeRange}
                ...
                getIssueExpectedEndLabel={getIssueExpectedEndLabel}
                getIssueFirstAffectedOrderLabel={getIssueFirstAffectedOrderLabel}
                getIssueLastAffectedOrderLabel={getIssueLastAffectedOrderLabel}
                getIssueRemainingMinutesLabel={getIssueRemainingMinutesLabel}
                getOrderRefLabel={getOrderRefLabel}
                getOrderVolumeFactor={getOrderVolumeFactor}
                getPkgBadgeClass={getPkgBadgeClass}
                getPkgLabel={getPkgLabel}
                handleFinishOrder={handleFinishOrder}
                handleStartOrder={handleStartOrder}
                lineDebug={lineDebug}
                manualOperatorOrderLines={manualOperatorOrderLines}
                nextNeedsProlineCleaning={nextNeedsProlineCleaning}
                nextOperatorOrder={nextOperatorOrder}
                nextOrderBunkerPlan={nextOrderBunkerPlan}
                nextOrderBunkerSwitches={nextOrderBunkerSwitches}
                openIssueDialog={openIssueDialog}
                operatorDisplayEntries={operatorDisplayEntries}
                operatorDropTargetId={operatorDropTargetId}
                operatorExecutionCards={operatorExecutionCards}
                operatorLeegBunkers={operatorLeegBunkers}
                plannedEntries={plannedEntries}
                persistIssue={persistIssue}
                reorderOperatorLineOrders={reorderOperatorLineOrders}
                resolveActiveIssue={resolveActiveIssue}
                selectedLine={selectedLine}
                setDraggedOperatorOrderId={setDraggedOperatorOrderId}
                setNewCalibrationCode={setNewCalibrationCode}
                setNewCalibrationName={setNewCalibrationName}
                setNewCalibrationValue={setNewCalibrationValue}
                setNotifications={setNotifications}
                setOperatorDropTargetId={setOperatorDropTargetId}
            ...
            {view === 'planner' && (
              <PlannerView
                ...
                changePlannerLineFilter={changePlannerLineFilter}
                changePlannerTab={changePlannerTab}
                chauffeurActionCounts={chauffeurActionCounts}
                chauffeurActionFilter={chauffeurActionFilter}
                chauffeurOrders={chauffeurOrders}
                chauffeurSearch={chauffeurSearch}
                chauffeurTypeFilter={chauffeurTypeFilter}
                completedOrderCount={completedOrderCount}
                completedOrders={completedOrders}
                config={config}
                currentTime={currentTime}
                dataSource={dataSource}
                dayRosterColumns={dayRosterColumns}
                dayRosterDriverColumns={dayRosterDriverColumns}
                dayRosterEntries={dayRosterEntries}
                dayRosterOrdersPerColumn={dayRosterOrdersPerColumn}
                dayRosterRowHeight={dayRosterRowHeight}
                dayRosterSlotCount={dayRosterSlotCount}
                dayRosterSlotMinutes={dayRosterSlotMinutes}
                dayRosterStartMinutes={dayRosterStartMinutes}
                ...
                formatPlannerDateHeading={formatPlannerDateHeading}
                formatPlannerDateLong={formatPlannerDateLong}
                gapDebug={gapDebug}
                ...
                getPkgBadgeClass={getPkgBadgeClass}
                getPkgLabel={getPkgLabel}
                getRunningOrderStart={getRunningOrderStart}
                getTransitionMinutes={getTransitionMinutes}
                handleAddDriver={handleAddDriver}
                handleAssignDriverToOrder={handleAssignDriverToOrder}
                handleClearCompletedOrders={handleClearCompletedOrders}
                handleClearDriverFromOrder={handleClearDriverFromOrder}
                handleDayRosterDragEnd={handleDayRosterDragEnd}
                handleDayRosterDragStart={handleDayRosterDragStart}
                handleRecalculate={handleRecalculate}
                handleResetArrived={handleResetArrived}
                handleRestoreCompletedOrder={handleRestoreCompletedOrder}
                handleToggleDriverAbsent={handleToggleDriverAbsent}
                isRecalculating={isRecalculating}
                isSavingDriver={isSavingDriver}
                lineTimelineByLine={lineTimelineByLine}
                lineTimelineEntryByOrderId={lineTimelineEntryByOrderId}
                ...
                plannerDriverCount={plannerDriverCount}
                plannerLineFilter={plannerLineFilter}
                plannerLockOwnerRef={plannerLockOwnerRef}
                plannerRecalcLock={plannerRecalcLock}
                plannerSearch={plannerSearch}
                plannerSelectedDate={plannerSelectedDate}
                plannerSort={plannerSort}
                plannerTab={plannerTab}
                plannerVisibleDates={plannerVisibleDates}
                plannerWeekDates={plannerWeekDates}
                selectedDriverName={selectedDriverName}
                selectedDriverOrders={selectedDriverOrders}
                selectedLine={selectedLine}
                setArrivedHoldLoadTime={setArrivedHoldLoadTime}
                setArrivedOrder={setArrivedOrder}
                setArrivedTime={setArrivedTime}
                setChauffeurActionFilter={setChauffeurActionFilter}
                setChauffeurSearch={setChauffeurSearch}
                setChauffeurTypeFilter={setChauffeurTypeFilter}
                setDraggedDayRosterOrderId={setDraggedDayRosterOrderId}
                ...
                visibleChauffeurOrders={visibleChauffeurOrders}
                visiblePlannerDriversSorted={visiblePlannerDriversSorted}
              />
            )}
            ...
            {view === 'settings' && (
              <SettingsView
                addBagVolumeRuleDraft={addBagVolumeRuleDraft}
                bagVolumeRuleDrafts={bagVolumeRuleDrafts}
                bagVolumeRuleFeedback={bagVolumeRuleFeedback}
                ...
                dataSource={dataSource}
                formatLocalDate={formatLocalDate}
                handleLocalOrderImport={handleLocalOrderImport}
                handleSaveBagVolumeRules={handleSaveBagVolumeRules}
                isClearingOrders={isClearingOrders}
                isImportingCsv={isImportingCsv}
                isSavingBagVolumeRules={isSavingBagVolumeRules}
                laadOrders={laadOrders}
                lineIds={lineIds}
                lineTiming={lineTiming}
                parseBagRuleCodesInput={parseBagRuleCodesInput}
                parseBagRuleNumber={parseBagRuleNumber}
                removeBagVolumeRuleDraft={removeBagVolumeRuleDraft}
                setConfig={setConfig}
                setCsvImportDate={setCsvImportDate}
                setLineTiming={setLineTiming}
                updateBagVolumeRuleDraft={updateBagVolumeRuleDraft}
                visiblePlannerTriggers={visiblePlannerTriggers}
              />
            )}
        </>
