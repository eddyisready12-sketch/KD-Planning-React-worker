...
const HEADER_MAP: Record<string, string[]> = {
  ...
  status: ['Status', 'Status Productie', 'status', 'orderstatus', 'statusorder', 'productiestatus', 'planningstatus', 'Productieorder status', 'productieorderstatus'],
  arrived: ['Gearriveerd', 'gearriveerd', 'Arriveerd', 'arriveerd', 'Aangekomen', 'aangekomen', 'arrived', 'isarrived', 'truck_arrived'],
  eta: ['Geplande starttijd', 'Start', 'ML Start', 'geplande starttijd', 'geplandestarttijd', 'plannedstart', 'planned_start', 'Laadtijd', 'eta', 'laadtijd', 'loadtime', 'tijd', 'aankomsttijd', 'tijdstip'],
  note: ['note', 'notitie', 'opmerking', 'remarks', 'memo', 'bijzonderheden', 'Transportmogelijkheden'],
